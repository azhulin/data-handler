...
let Handler = /** @class */ (() => {
    class Handler extends data_validator_1.Handler {
        ...
        async formatBaseToStore(data, baseContext) {
            ...
            throw new Error.InternalFormat(this.path, this.id, Format_1.default.base, Format_1.default.store, data);
        }
        /**
        ...
        async formatBaseToOutput(data, baseContext) {
            ...
            throw new Error.InternalFormat(this.path, this.id, Format_1.default.base, Format_1.default.output, data);
        }
        /**
        ...
        async formatStoreToBase(data, baseContext) {
            ...
            throw new Error.InternalFormat(this.path, this.id, Format_1.default.store, Format_1.default.base, data);
        }
        /**
